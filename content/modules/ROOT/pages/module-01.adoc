...
[TIP]
====
If you have trouble copying and pasting into the VS Code terminal, you can open VS Code in a separate browser tab: link:https://vscode-$\{guid}.$\{domain}/[Open VS Code in external tab,window=_blank]
====
